...
function log_trace() {
    _should_log trace && echo -e "${__color_blue}trc:${__color_reset}" $@ || true
}
...
function log_warn() {
    _should_log warn && echo -e "${__color_yellow}wrn:${__color_reset}" $@ || true
}

function log_error() {
    _should_log error && echo -e "${__color_red}err:${__color_reset}" $@ || true
}
